...
import { ZardIconComponent } from '@shared/components/z-icon/icon.component';
import type { ZardIcon } from '@shared/components/z-icon/icons';
...
@Component({
  ...
  template: `
    ...
    <main class="mt-4 px-4 flex min-h-0 flex-col space-y-4 overflow-y-auto">
